...
const NewsData = ({state ='flex'} , {setState = 'none' }) => {


    // const arrayOfComponents = {
    //     allNews: <AllNewsBlock/>,
    //     lostFound: <LostFoundBlock />,
    //     topNews: <TopsNewsBlock />,
    //     updates: <UpdatesBlock  />,
    //
    // }
    return (
        <div>
            <AllNewsBlock display={state === 0 ? 'block': 'hidden' }  state={state}  setState={setState} index={0} />
